...
class _ShoppingCartTabState extends State<ShoppingCartTab> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('pin', pin));
...
class ShoppingCartItem extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<bool>('lastItem', lastItem));
    properties.add(IntProperty('quantity', quantity));
    properties.add(DiagnosticsProperty<NumberFormat>('formatter', formatter));
  }
}
